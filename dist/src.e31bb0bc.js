...
var author$project$Main$DisplayGame = function (a) {
	return {$: 'DisplayGame', a: a};
};
var author$project$Main$Nothing = {$: 'Nothing'};
var author$project$Main$StaticValue = function (a) {
	return {$: 'StaticValue', a: a};
};
...
var author$project$Main$convertSudokuRow = function (row) {
	var convertCell = function (val) {
		if (!val) {
			return author$project$Main$Nothing;
		} else {
			return author$project$Main$StaticValue(val);
		}
	};
	return elm$core$Array$fromList(
		A2(elm$core$List$map, convertCell, row));
};
var author$project$Main$createSudokuFromLists = function (state) {
	return elm$core$Array$fromList(
		A2(elm$core$List$map, author$project$Main$convertSudokuRow, state));
};
var author$project$Main$getInitialGame = author$project$Main$createSudokuFromLists(
	_List_fromArray(
		[
			_List_fromArray(
			[0, 0, 8, 0, 0, 3, 0, 0, 2]),
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$DisplayGame(author$project$Main$getInitialGame),
...
var author$project$Main$convertGameToList = function (game) {
	return elm$core$Array$toList(
		A2(elm$core$Array$map, elm$core$Array$toList, game));
};
...
var author$project$Main$displayColumns = function (columns) {
	var displayColumn = function (column) {
		switch (column.$) {
			case 'StaticValue':
				var value = column.a;
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('cell flex')
						]),
					_List_fromArray(
						[
							elm$html$Html$text(
	...
	var cellContents = A2(elm$core$List$map, displayColumn, columns);
	return _List_fromArray(
		[
			A2(
			elm$html$Html$div,
...
var author$project$Main$displayRows = function (rows) {
	var displayRow = function (row) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			author$project$Main$displayColumns(row));
	};
	return A2(elm$core$List$map, displayRow, rows);
};
var author$project$Main$displayTable = function (_n0) {
	var game = _n0.a;
	var convertedGame = author$project$Main$convertGameToList(game);
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		author$project$Main$displayRows(convertedGame));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$displayTable(model)
			]));
};
...
var elm$browser$Debugger$Main$toDragListeners = function (layout) {
	var _n0 = elm$browser$Debugger$Main$getDragStatus(layout);
	if (_n0.$ === 'Static') {
		return _List_Nil;
	} else {
		return _List_fromArray(
...
var elm$browser$Debugger$Main$viewExpando = F3(
	function (expandoMsg, expandoModel, layout) {
		...
		var _n0 = elm$browser$Debugger$Main$toExpandoPercents(layout);
		var w = _n0.a;
		var h = _n0.b;
		return A2(
			elm$html$Html$div,
...
var elm$browser$Debugger$History$viewSnapshot = F3(
	function (selectedIndex, index, _n0) {
...
var elm$browser$Debugger$History$consSnapshot = F3(
	function (selectedIndex, snapshot, _n0) {
		var index = _n0.a;
		var rest = _n0.b;
	...
	function (selectedIndex, recentMessagesNum, snapshots) {
		...
		var snapshotsToRender = function () {
			...
			if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Just')) {
				var fillerSnapshot = _n0.a.a;
				var recentSnapshot = _n0.b.a;
				return elm$core$Array$fromList(
					_List_fromArray(
						[
							{
...
var elm$browser$Debugger$Main$viewHistory = F3(
	function (maybeIndex, history, layout) {
		var block = elm$browser$Debugger$Main$toMouseBlocker(layout);
		var _n0 = elm$browser$Debugger$Main$toHistoryPercents(layout);
		var w = _n0.a;
		var h = _n0.b;
		return A2(
			elm$html$Html$div,
...
var elm$browser$Debugger$History$getRecentMsg = function (history) {
	getRecentMsg:
	while (true) {
		var _n0 = history.recent.messages;
		if (!_n0.b) {
...
var elm$browser$Debugger$Main$jumpUpdate = F3(
	function (update, index, model) {
		...
		var _n0 = A3(elm$browser$Debugger$History$get, update, index, history);
			...
			switch (msg.$) {
				...
				case 'Upload':
					...
					return A2(
						...
						model,
						function (metadata) {
							var _n7 = A2(elm$browser$Debugger$Overlay$assessImport, metadata, jsonString);
							if (_n7.$ === 'Err') {
								var newOverlay = _n7.a;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{overlay: newOverlay}),
								...
								var rawHistory = _n7.a;
								return A3(elm$browser$Debugger$Main$loadNewHistory, rawHistory, update, model);
							}
						});
				case 'OverlayMsg':
					var overlayMsg = msg.a;
					var _n8 = A2(elm$browser$Debugger$Overlay$close, overlayMsg, model.overlay);
					if (_n8.$ === 'Nothing') {
						return _Utils_Tuple2(
							_Utils_update(
								model,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"None":[]}}}}})}});
...
},{"./Main.elm":"Main.elm"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
